...
void topic0()//Topic name is General Knowledge
{
  ...
  for(i=0;i<11;i++)
  {
   ...
   system("clear");
   printf("          ~~~~~Topic: General Knowledge~~~~~");
   printf("\n\n\n\n\n          Correct Answers:%d\n           Wrong Answers:%d\n",corr,wrong);
   restart();
}
...
void topic4()//Topic name is Indian History
{
  ...
  for(i=1;i<=10;i++)
  {
        ...
        switch(r)
    {
        ...
        case 3:{
                c=3;
                printf("          The use of Kharoshti in ancient Indian architecture is the result of \n          India's contact with ________\n");
        ...
        case 4:{
                c=2;
                printf("          We hear of two envoys being sent to the Roman kings, one in 27-28 AD to \n           the court of Augustus and the other in 110-20 AD to the court of ________\n");
                printf("          1) Cartius\n");
                printf("          2) Trajan\n");
                printf("          3) Nero\n");
                printf("          4) Brutus\n");
        ...
        case 5:{
                c=4;
                printf("          The troops raised by the emperor but not paid directly the state and \n          place under the charge of mansabadars were know as ________\n");
                printf("          1) Walashahi\n");
                printf("          2) Barawardi\n");
                printf("          3) JCumaki\n");
                printf("          4) Dakhili\n");
        ...
        case 9:{
                c=3;
                printf("          The title of 'Viceroy' was added to the office of the Governor-General \n          of India for the first time in ________\n");
                printf("          1) 1848 AD\n");
                printf("          2) 1856 AD\n");
                printf("          3) 1858 AD\n");
                printf("          4) 1862 AD\n");
